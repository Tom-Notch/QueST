...
1. We would also like to thank the authors of our baselines [VQ-BeT](https://github.com/jayLEE0301/vq_bet_official), [ACT](<>), and [Diffusion Policy](<>) for providing the codebase for their methods; and the authors of [Robomimic](<>) from which we adapted the utility files for our codebase.
