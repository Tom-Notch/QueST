...
class QueST(ChunkPolicy):
    ...
    def get_optimizers(self):
        if self.stage == 0:
            ...
            decoder_decay, decoder_no_decay = TensorUtils.separate_no_decay(
    ...
    def compute_prior_loss(self, data):
        ...
        start_tokens = (
            torch.ones((context.shape[0], 1), device=self.device, dtype=torch.long)
            * self.start_token
        )
